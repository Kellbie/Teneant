...
var taskObj = {
        ...
        for (var a = 0; a < projects.length; a++) {
            ...
            for (var b = 0; b < projects[a].tasks.length; b++) {
                ...
                if (projects[a].tasks[b].isStarted) {
                    ...
                    html += "<td data-started='" + JSON.stringify(dataStartedObj) + "'>" + hours + ":" +
                        minutes + ":" + seconds + "</td>";
                } else {
                ...
                if (projects[a].tasks[b].status == "Completed") {
                    html += "<td>" + projects[a].tasks[b].started +
                        "<br><span style='margin-left: 30px;'>to</span><br>" + projects[a].tasks[b].ended +
                        "</td>";
                } else {
                ...
                html += "<td>";
                html += "<form method='POST' id='form-change-task-status-" + projects[a].id + projects[a].tasks[
                    b].id + "'>";
                ...
                html +=
                    ...
                    projects[a].id + projects[a].tasks[b].id + "'>";
    ...
    getCurrentTimeInTaskStartEndFormat() {
        ...
        seconds = (seconds < 10) ? "0" + seconds : seconds;
        let formatted_date = current_datetime.getFullYear() + "-" + month + "-" + date + " " + hours + ":" +
            minutes + ":" + seconds;
                        ...
                        if (projects[a].tasks[b].id == dataStartedObj.task) {
                            for (var c = 0; c < projects[a].tasks[b].logs.length; c++) {
                                if (c == projects[a].tasks[b].logs.length - 1) {
                                    ...
                                    // update timer
                                    dataStarted[i].setAttribute("data-started", JSON.stringify(
                                        dataStartedObj));
...
<div class="container" style="margin-top: 50px; margin-bottom: 50px;">
    ...
    <div class="row" style="margin-bottom: 50px;">
        <div class="col-md-12">
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addTaskModal">Add
                Task</button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" onsubmit="return taskObj.addTask(this);" id="form-task-hour-calculator">
                    ...
                    <div class="form-group">
                        <label>Task</label>
                        <input type="text" name="task" class="form-control" placeholder="What are you going to do ?"
                            required />
                    </div>
                </form>
            </div>
